...
class TestExamples(unittest.TestCase):
    ...
    @patch('day_13.solution.read_inputs', return_value=read_inputs(CURRENT_DIRECTORY, 'sample.txt'))
    def test_part_1(self, mocked_read_inputs):
        self.assertEqual(part_1(), '7,3')

    @patch('day_13.solution.read_inputs', return_value=read_inputs(CURRENT_DIRECTORY, 'sample2.txt'))
