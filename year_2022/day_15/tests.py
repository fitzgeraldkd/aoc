...
from year_2022.day_15.solution import part_1, part_2
...
class TestExamples(unittest.TestCase):
    ...
    @patch('year_2022.day_15.solution.read_inputs', return_value=read_inputs(CURRENT_DIRECTORY, 'sample.txt'))
    @patch('year_2022.day_15.solution.PART_1_TARGET_ROW', 10)
    def test_part_1(self, mocked_read_inputs):
        self.assertEqual(part_1(), 26)

    @patch('year_2022.day_15.solution.read_inputs', return_value=read_inputs(CURRENT_DIRECTORY, 'sample.txt'))
    @patch('year_2022.day_15.solution.PART_2_MAX_COORDINATE', 20)
