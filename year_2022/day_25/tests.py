...
from year_2022.day_25.solution import decimal_to_snafu, part_1, part_2, snafu_to_decimal
...
class TestExamples(unittest.TestCase):
    ...
    def test_part_1(self):
        with patch('year_2022.day_25.solution.read_inputs', return_value=read_inputs(__file__, 'sample.txt')):
