...
from day_21.solution import parse_input, part_1, part_2, reverse_value
...
class TestExamples(unittest.TestCase):
    ...
    @patch('day_21.solution.read_inputs', return_value=read_inputs(CURRENT_DIRECTORY, 'sample.txt'))
